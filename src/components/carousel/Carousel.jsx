...
const Carousel = () => {
    ...
    return (
        <div className='carousel'>
            <AliceCarousel items={items} responsive={responsive} mouseTracking disableButtonsControls disableDotsControls infinite autoPlayInterval={1500} autoPlay animationDuration={1500}  />
        </div>
    )
}
